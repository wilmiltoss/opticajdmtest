<?php 
	...
	class Login extends Controllers{
		...
		public function resetPass(){
			if($_POST){
				error_reporting(0); //evita la impresion del error en la consola
						...
						if($requestUpdate){
							...
							if($sendEmail){
								...
								$arrResponse = array('status' => false, 
												 'msg' => 'No es posible el envio del email, intenta más tarde.' );
							}
						}else{
							$arrResponse = array('status' => false, 
												 'msg' => 'No es posible realizar el proceso de token, intenta más tarde.' );
						}
					}
				}
