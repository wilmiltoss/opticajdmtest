<?php headerAdmin($data); // llamamos todo el html del templates modelo de header_admin.php?>
...
<?php footerAdmin($data); // llamamos a la clase de las funciones almacenadas?>
